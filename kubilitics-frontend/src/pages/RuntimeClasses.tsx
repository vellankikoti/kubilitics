...
`,
 ...
 return (
 <PageLayout label="Runtime Classes">
 ...
 <button className="font-medium flex items-center gap-2 truncate cursor-pointer text-primary hover:underline bg-transparent border-none p-0 text-left" onClick={() => navigate(`/runtimeclasses/${item.name}`)}>
