...
// Auto-updates are handled by tauri-plugin-updater.
// The plugin checks GitHub Releases for latest.json, downloads signed
// updates in background, and applies them on restart.
// No custom commands needed — the frontend uses @tauri-apps/plugin-updater directly.
